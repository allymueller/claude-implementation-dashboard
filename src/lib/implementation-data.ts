...
export const implementationSteps: ImplementationStep[] = [
  {
    ...
    description: 'Confirm your organization details and get started',
    estimatedMinutes: 10,
    order: 1,
    required: true,
  ...
  },
  {
    id: 'step-002', 
    category: 'Foundation',
    title: 'Connect Your Company Login System',
    description: 'Set up single sign-on so your team can use their work credentials',
    estimatedMinutes: 15,
    order: 2,
  ...
  },
  {
    ...
    description: 'Add team members and decide who can access what',
    estimatedMinutes: 60,
    order: 3,
  ...
  },
  {
    ...
    description: 'Configure data retention, compliance, and security settings',
    estimatedMinutes: 30,
    order: 4,
  ...
  },
  {
    ...
    description: 'Roll out Claude across your organization and get everyone up to speed',
  ...
  },
  {
    ...
    description: 'Track how your team is using Claude and make improvements',
    estimatedMinutes: 30,
    order: 6,
    ...
    resources: [
      ...
      {
        title: 'How to Access Audit Logs',
        url: 'https://support.anthropic.com/en/articles/9970975-how-to-access-audit-logs#h_3d56c7eebb',
        type: 'documentation'
      }
    ]
  },
  {
    id: 'step-007',
    category: 'Optimization',
    title: 'Celebrate Success and Plan Next Steps',
    description: 'Review your implementation with your Anthropic team and plan for the future',
    estimatedMinutes: 15,
    order: 7,
